module Icons.PokerChip exposing (PokerChipOptions, pokerChip)
...
pokerChip options =
    let
        ...
        fontSizeStr =
            String.fromFloat (options.size * 0.2)
    in
    Html.div
        ...
        , Html.div
            ...
            (Svg.svg
                ...
                [ Svg.circle
                    ...
                    , cy "128"
                    , r "100"
                    , fill (Icons.Internal.colorToRgbString options.color)
                    ]
                    []
                , Svg.path
                ...
                :: (case options.value of
                        Just value ->
                            [ Html.div
                                [ Html.Attributes.class "chip-text-front"
                                , Html.Attributes.style "color" textColorStr
                                , Html.Attributes.style "font-size" (fontSizeStr ++ "px")
                            ...
                            , Html.div
                                [ Html.Attributes.class "chip-text-back"
                                , Html.Attributes.style "color" textColorStr
                                , Html.Attributes.style "font-size" (fontSizeStr ++ "px")
                                , Html.Attributes.style "font-weight" "bold"
                                , Html.Attributes.style "text-align" "center"
